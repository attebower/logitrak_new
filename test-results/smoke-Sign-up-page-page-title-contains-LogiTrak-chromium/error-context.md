...
- Name: smoke.spec.ts >> Sign-up page >> page title contains LogiTrak
...
Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    2 × unexpected value "404: This page could not be found."
    7 × unexpected value "Reelbooks — Accountancy Built for Film"
